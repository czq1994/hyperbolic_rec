...
class Books(DataSet):
    def __init__(self):
        ...
        self.num_users = 77754
        self.num_items = 66963
    ...
    def generate_dataset(self, seed=0, user_shift=0, item_shift=0):
        ...
        train_matrix = self.generate_csr_matrix(train_set, self.num_users + user_shift, self.num_items + item_shift, user_shift, item_shift)
        train_set = self.list_index_shift(train_set, increase_by=user_shift)
        test_set = self.list_index_shift(test_set, increase_by=item_shift)
